        ...
        return (
            <div style={st}>
                ...
                {this.props.header == undefined && textHeader == undefined ? null :
                    <div style={this.componentStyle.headerPlaceholder} className={'headerPlaceholder'} >
                ...
                <div style={this.componentStyle.closeButtonPlaceholder} onClick={this.onCloseClick}>
